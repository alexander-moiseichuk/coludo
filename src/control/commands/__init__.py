...
def command(name: str, help_text: str = ''):
    ...
    Args:
        name - the operator command name.
        help_text - the one-line help shown by `help`.
...
def load() -> dict:
    """
    Import every command module in this package so each self-registers.

    Args:
        (none)

    Returns:
        The command REGISTRY (name -> _Command).
    """
